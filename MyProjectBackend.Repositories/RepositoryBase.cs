...
public abstract class RepositoryBase<TEntity> : DbContextConnector<TEntity, MyProjectDbContext>, IRepositoryBase<TEntity>
    where TEntity : class, IEntity
{
    public RepositoryBase(MyProjectDbContext context) : base(context) { }
